...
console.log(obj); // allObj {a: "1",age: "12",b: "2",c: "3",invisible: {enumerable: false,value: 'hello'},name: "张三",visible: "word",Symbol(c): "c"}
...
// Object.keys()返回一个数组，包括对象自身的所有属性（不含Symbol属性）
console.log(Object.keys(obj)); // ["name", "age", "a", "b", "c", "invisible", "visible"]

// Object.getOwnPropertyNames返回一个数组，包含对象自身的所有属性（不含Symbol属性，但是包括不可枚举属性 ）
console.log(Object.getOwnPropertyNames(obj)); // ["name", "age", "a", "b", "c", "invisible", "visible"]
...
console.log(Reflect.ownKeys(obj)); // ["name", "age", "a", "b", "c", "invisible", "visible", Symbol(c)]
```
